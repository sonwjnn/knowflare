  ...
  return (
    <form onSubmit={onClick} className="relative">
      ...
      >
        <motion.button
          type="button"
          className={cn(`absolute left-0 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-transparent ${
          ...
          {isExpanded && (
            ...
            >
              <Input
                ...
                onBlur={handleBlur}
                value={value}
                className={cn("h-10 w-full rounded-full border bg-transparent pl-12 pr-10 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-transparent focus-visible:ring-offset-2", className)}
