                                ...
                                {categories?.map(category => (
                                    <div key={category.id} className="group relative">
                                        <button
                                            ...
                                            className={`w-full rounded-lg p-3 text-left transition-all hover:bg-blue-50 ${category.id === categoryId ? 'bg-blue-50' : ''
                                                }`}
                                        >
                    ...
                    <div className="grid grid-cols-1 gap-2">
                        {levels.map(item => (
                            <button
                                ...
                                className={`group flex items-center gap-3 rounded-lg border p-4 transition-all hover:border-blue-200 hover:bg-blue-50 ${item === level
                                        ? 'border-blue-200 bg-blue-50'
                                        : 'border-gray-100 bg-white'
                                    }`}
                            >
                                <div
                                    className={`rounded-full p-2 ${item === level
                                ...
                                <span
                                    className={`text-sm font-medium capitalize ${item === level ? 'text-blue-600' : 'text-gray-700'
                                        }`}
                                >
                                    {item.toLowerCase()}
                                </span>
                    ...
                    <div className="space-y-2">
                        {['5', '4', '3'].map(stars => (
                            <button
                                ...
                                className={`group relative w-full overflow-hidden rounded-lg border p-4 transition-all hover:border-blue-200 hover:bg-blue-50 ${rating === stars
                                        ? 'border-blue-200 bg-blue-50'
                                        : 'border-gray-100 bg-white'
                                    }`}
                            >
