...
import { coupons, insertCouponsSchema } from '@/db/schema'
import { useDeleteCoupon } from '@/features/admin/coupons/api/use-delete-coupon'
...
export function DataTableRowActions<TData>({
  ...
  const coupon = insertCouponsSchema.parse(row.original)

  const { mutate: deleteCoupon, isPending: deleteCouponLoading } =
  ...
  return (
    <>
      <ConfirmDialog />
      <DropdownMenu>
        <DropdownMenuTrigger asChild disabled={deleteCouponLoading}>
          <Button
            variant="ghost"
