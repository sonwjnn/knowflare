...
export const Cart = ({ className }: { className?: string }) => {
  ...
  return (
    <div
      className={cn("group relative border-none bg-transparent p-2 hover:bg-transparent", className)}
      onClick={() => setOpen(true)}
    >
      <ShoppingCart
        className={cn('size-5', open && 'text-blue-500 transition-colors', className)}
      />
      {!cartsLoading && (
