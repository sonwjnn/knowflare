        ...
        return (
            <div className="flex h-[80vh] items-center justify-center">
                <div className="flex w-full max-w-md flex-col items-center justify-center rounded-xl bg-gradient-to-b from-primary/5 to-primary/10 p-8 shadow-lg">
                    ...
                    <h2 className="mt-6 text-2xl font-bold tracking-tight">No Purchased Courses</h2>
                    <p className="mt-4 text-center text-muted-foreground">
                        Ready to start learning? Explore our course catalog and begin your educational journey today!
                    </p>
        ...
        <div className="min-h-screen space-y-8 px-4 py-24 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <Tabs defaultValue="all" className="mt-12">
                    <TabsList className="mb-8 py-4 bg-">
